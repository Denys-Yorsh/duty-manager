# Модуль «Графік нарядів ВЧ V1.1.2 release»
...
### Інструкція зі встановлення та збирання модуля «Графік нарядів ВЧ V1.1.2 release»
  ...
  Щоб програма запускалася на іншому комп'ютері без встановленого Qt, виконайте наступне:
   ...
   5. Відкрийте термінал (PowerShell) та скористайтеся утилітою windeployqt, яка
      ...
      C:\Qt\6.5.x\msvc2022_64\bin\windeployqt.exe D:\путь_до_вашої_папки\DutyManager.exe
